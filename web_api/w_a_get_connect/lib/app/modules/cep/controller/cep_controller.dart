...
import '/app/modules/cep/datasource/cep_http.dart';
...
class CepController extends GetxController {
  final CepConnect connect;

  CepController({required this.connect});
  ...
  Future<void> searchCep() async {
    ...
    final mapCep = await connect.getCep(controllerText.text);
